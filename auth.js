(() => {
  ...
  const unlock = async () => {
    ...
    try {
      ...
      await loadStyle("artwork-upload.css?v=3");
      await loadScript("artwork-upload.js?v=3");
      await loadStyle("artwork-image-manager.css?v=1");
      await loadScript("artwork-image-manager.js?v=1");
      setupPasswordChange();
